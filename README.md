...
🦇 Symmetrical Batman Signal: 3D CAD Modeling
This repository documents the advanced 3D CAD design of the Batman Signal developed from scratch in Onshape.
The project focuses on geometric constraints, precise spline control, and high-contrast multi-layered extrusion without relying on external raster tracing.
...
Ellipse Generation: Mathematically defining the major and minor axes of the outer boundary.

Spline & 3-Point Arc Intersections: Interlocking continuous smooth curves with sharp geometric corners (such as the ears and wing tips).
